...
public class SaplingTransformer extends ItemDataTransformer {
    ...
    public ItemData transform(ItemData original) {
        ...
        int damage = map.isEmpty() || map.getString("sapling_type").isEmpty() ? 0 : xyz.syodo.utils.transformer.blocks._1_20_80.SaplingTransformer.SaplingType.valueOf(map.getString("sapling_type").toUpperCase()).ordinal();
