...
import static cn.nukkit.block.BlockID.COLORED_TORCH_RG;

public class ColoredTorchRgTransformer extends BlockStateTransformer {

    @Override
    public BlockState transform(BlockState original) {
        BlockProperties PROPERTIES = new BlockProperties(COLORED_TORCH_RG, CommonBlockProperties.COLOR_BIT, CommonBlockProperties.TORCH_FACING_DIRECTION);
