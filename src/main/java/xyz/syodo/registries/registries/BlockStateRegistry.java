...
import xyz.syodo.utils.transformer._712.DirtStateTransformer;
import xyz.syodo.utils.table.BlockStateTable;
...
public class BlockStateRegistry extends Registry {
    ...
    public void init() {
        ...
        TABLES.add(new BlockStateTable(ProtocolVersion.MINECRAFT_PE_1_21_20,
                of(CUT_SANDSTONE),
